...
DAEMON_ARGS="/home/yuji/wwwroot/ooxx/server.js"               # path to your node.js server/app
                                            # NB: don't use ~/ in path
 
DESC="ooxx server"                  # whatever fancy description you like
 
NODEUSER=yuji:root                     # USER who OWNS the daemon process (no matter whoever runs the init script)
